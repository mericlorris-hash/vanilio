...
class ShopifyOrderDataQueueLineEpt(models.Model):
    ...
    def create_order_data_queue_line(self, orders_data, instance, queue_type, created_by="import"):
        ...
        Task Id : 157350
        """
        if instance.use_graphql_api and created_by != 'webhook':
            return self.create_order_data_queue_line_by_gql_api(orders_data, instance, queue_type, created_by=created_by)
        count = 0
        order_queue = False
